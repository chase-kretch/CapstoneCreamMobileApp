...
namespace backend.Migrations.SqliteMigrations
{
    ...
    [Migration("20241017135936_PermanentMigrationmessages")]
    partial class PermanentMigrationmessages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.Entities.MessageStore", b =>
                {
            ...
            modelBuilder.Entity("backend.Models.Entities.MessageStore", b =>
                {
                    b.HasOne("backend.Models.Entities.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("backend.Models.Entities.User", "Sender")
                        .WithMany()
